            ...
            <div className="container max-w-5xl mx-auto px-6">
                ...
                {!user && (
                    <div className="glass-card p-6 mb-8 flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <p className="font-semibold text-[var(--text-primary)]">API Key Required</p>
                ...
                <div className="flex gap-2 mb-8">
                    <button
                        ...
                        className={`pill pill-hover ${activeTab === 'screenshot' ? 'pill-active' : ''}`}
                    >
                    ...
                    <button
                        ...
                        className={`pill pill-hover ${activeTab === 'colors' ? 'pill-active' : ''}`}
                    >
