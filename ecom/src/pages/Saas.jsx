...
import { useSaasTools } from "../hooks/useQueries";
...
const Saas = () => {
    ...
    const getApiKey = async (tool) => {
        ...
        try {
            const res = await api.post("/saas/generate-key", { toolId: tool.id });
    ...
    return (
        <div className="page-container">
            ...
            <section className="relative pt-32 pb-20">
                ...
                <div className="absolute top-20 right-1/4 w-96 h-96 bg-[var(--accent-primary)] opacity-[0.03] rounded-full blur-3xl" />
                ...
                <div className="container max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-display text-[var(--text-primary)] mb-6">
                            Build faster with <span className="text-[var(--accent-primary)]">powerful APIs</span>
                        </h1>

                        <p className="text-body text-lg mb-10 max-w-2xl">
            ...
            {/* Categories */}
            <section className="py-8 border-y border-[var(--border-primary)] bg-[var(--bg-secondary)]">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`pill pill-hover flex items-center gap-2 ${selectedCategory === cat.id ? 'pill-active' : ''
                                    }`}
                            >
