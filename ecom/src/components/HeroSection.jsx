...
const HeroSection = () => {
    return (
        <div className="relative w-full bg-[#F5F5F7] min-h-[90vh] flex flex-col justify-center px-6 py-20 overflow-hidden font-sans">

            {/* 
        Custom CSS for the Infinite Scroll Animation 
        This makes the logos scroll smoothly within their div 
      */}
            {/* 
        Custom CSS for the Infinite Scroll Animation 
        This makes the logos scroll smoothly within their div 
      ...
      */}
            ...
            <div className="max-w-[1400px] mx-auto w-full flex flex-col gap-16 relative z-10">
                ...
                <div className="flex flex-col items-start text-left">
                    ...
                    {/* Line 1 */}
                    <h1 className="text-6xl md:text-8xl lg:text-[5rem] leading-[0.9] font-black text-black tracking-tight mb-4 md:mb-6 animate-fade-in-up">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-baseline justify-start gap-4 md:gap-8 w-full animate-fade-in-up delay-100">
                        ...
                        <div className="hidden md:flex shrink-0 w-20 h-20 md:w-24 md:h-24 bg-white rounded-[1.8rem] shadow-[0_30px_60px_-15px_rgba(0,85,255,0.25)] items-center justify-center transform -rotate-6 hover:scale-110 hover:rotate-0 transition-all duration-500 ease-out relative top-2 cursor-pointer z-10 group">
                            ...
                            <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl bg-[#0055FF] flex items-center justify-center shadow-inner group-hover:shadow-[inset_0_4px_10px_rgba(0,0,0,0.2)] transition-shadow">
                        ...
                        {/* Text: "templates for" */}
                        <h1 className="text-6xl md:text-8xl lg:text-[5rem] leading-[0.9] font-black text-black tracking-tight">
                            templates for
                        </h1>
                    ...
                    {/* Line 3 */}
                    <h1 className="text-6xl md:text-8xl lg:text-[5rem] leading-[0.9] font-black text-black tracking-tight mt-4 md:mt-2 animate-fade-in-up delay-200">
                        creators & founders.
                    </h1>
                </div>
